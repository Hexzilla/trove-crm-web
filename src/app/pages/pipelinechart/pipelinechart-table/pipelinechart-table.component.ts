...
@Component({
  selector: 'app-pipelinechart-table',
  templateUrl: './pipelinechart-table.component.html',
  styleUrls: ['./pipelinechart-table.component.css']
})
export class PipelinechartTableComponent implements AfterViewInit {
